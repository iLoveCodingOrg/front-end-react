...
export default () => (
  <div className="my-1">
    ...
    <div><CheckMark />{' '} 5 Modules (11+ Courses, 20+ practice projects)</div>
    ...
    <div><CheckMark />{' '} Module 4: Mobile Development (iOS and Android)</div>
    ...
    <div><CheckMark />{' '} Certification Upon Master Project Completion </div>
    <br />
