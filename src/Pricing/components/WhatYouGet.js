            ...
            <div className="bg-white rounded p-6">
                <div className="row mb-7">
                    ...
                    <div className="col-lg-8 pl-lg-5">
                        ...
                        <CheckMark /> 5 Modules (11+ Courses, 20+ practice projects)<br/>
                        <CheckMark /> Module 1: Fundamentals of Programming and Web<br/>
                ...
                <div className="row mb-7">
                    ...
                    <div className="col-lg-8 pl-lg-5">
                        ...
                        <CheckMark /> Learn from your peers<br/>
                        <CheckMark /> Get career, code, and project help
                    </div>
                </div>
                ...
                <div className="row">
                    ...
                    <div className="col-lg-8 pl-lg-5">
                        ...
                        <CheckMark /> See how your mentor troubleshoots problems<br/>
                        <CheckMark /> Share your screen with your mentor<br/>
                        <CheckMark /> Live code reviews<br/>
                        <CheckMark /> Live career guidance<br/>
                        <CheckMark /> Live resume, code and portfolio feedback<br/>
                        
                        <br/>

                        <p><strong>Important:</strong> Weekly Group Calls are for iLoveCoding Premium members only. iLoveCoding Pro members can always get help from mentor in the Mentor-Moderated Private Student Community.</p>
                    </div>
                </div>
            </div>
        </div>
