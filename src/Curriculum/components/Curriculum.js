                ...
                <div className="row border-top pt-4">
                    <div className="col-md-4">
                        <p className="lead alert alert-warning text-dark">
                            <strong>Important:</strong> This curriculum will give you the complete training of the deep technical concepts, homework, cheatsheets and practice projects so become a highly-skilled software developer.&nbsp;
