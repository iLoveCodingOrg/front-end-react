...
export function buy(slug, { firstName, lastName, email, nonce, coupon, recaptchaToken }){
    ...
    return (dispatch) => {
        ...
        return fetch(url, {
            ...
            body: jsonToUrlEncoded({ firstName, lastName, email, nonce, coupon, recaptchaToken })
        })
        .then(checkStatus)
        .then(parseJSON)
