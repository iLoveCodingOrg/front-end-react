...
export default function ({ id, className }) {
  return (
    <div id={id} className={`${className} container container-slim flex-row`}>
      <img
        loading="lazy"
      ...
      <div>
        ...
        <div className="blockquote">
          ...
          <p>I gave up on coding for 9 years. Discouraged and demoralized with my confidence crushed.</p>
          <p>
