  ...
  return (
    <div className="d-flex flex-column align-items-center">
      ...
      <h3 className="f-300 col-lg-9 align-self-center">
        ...
        {' '}
        Front-End and/or Full-Stack JavaScript Developer - Someone who can build modern web, mobile and desktop apps.
        <br />
        <br />
        Each course has at least 2 practical projects, so you apply what you learn in the course. For additional practice go to the
        {' '}
        <Link to="/courses/projects">Practice Projects</Link>
        {' '}
        section.
      </h3>
    </div>
